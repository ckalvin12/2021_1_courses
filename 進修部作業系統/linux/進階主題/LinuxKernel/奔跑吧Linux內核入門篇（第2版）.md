...
本書基於Linux 5.0和ARM64處理器循序漸進地講述Linux內核的理論與實驗。
本書共16章，主要介紹Linux系統基礎知識、Linux內核基礎知識、ARM64架構基礎知識、內核編譯和調試、
內核模塊、簡單的字符設備驅動、系統調用、進程管理、內存管理、同步管理、中斷管理、調試和性能優化、
開源社區、文件系統、虛擬化與雲計算等方面的內容，並通過一個綜合能力訓練來引導讀者動手實現一個小的操作系統。
```
